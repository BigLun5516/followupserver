...
public interface TaskRepository extends JpaRepository<TaskModel, Long> {
    ...
    @Query(nativeQuery = true, value = "SELECT a.task_id,a.title,a.content,a.grade,a.scale_id,a.create_time,b.university_name,c.scale_name " +
            "FROM `management_task` a LEFT JOIN management_university b on a.university_id=b.university_id " +
            "LEFT JOIN management_scale c ON a.scale_id=c.scale_id  WHERE (a.university_id= ?1 or ?1=-1)" )
